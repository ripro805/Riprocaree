...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edEmail = findViewById(R.id.editTextBMAddress);
        edPassword = findViewById(R.id.editTextBMContactNumber);
        edConfirmPassword = findViewById(R.id.editTextAppFees);
        btn = findViewById(R.id.buttonBMBooking);
                    ...
                    if (password.compareTo(ConPassword) == 0) {
                        ...
                        if(isValid(password))
                        {
                          ...
                          startActivity(new Intent(RegisterActivity.this,LoginActivity.class));
                            ...
                            Toast.makeText(getApplicationContext(), "Password must contain 8 chracter having letter,digit and special character", Toast.LENGTH_SHORT).show();
                        }
